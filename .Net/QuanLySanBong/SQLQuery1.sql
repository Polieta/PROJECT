...
VALUES 
	(1, N'Nhân Viên'),
    (2, N'Quản Lý')
INSERT INTO NhanVien(MaNV,TenNV,GioiTinh,DIACHI,SoCMND,SODIENTHOAI,Luong)
VALUES 
	(1,N'Nguyễn Văn A',N'Nam',N'TP.HCM',123123123,0777344272,7500000),
	(2,N'Trần Văn B',N'Nữ',N'Hà Nội',123444333,0777555272,9500000)
